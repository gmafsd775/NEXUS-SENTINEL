...
model_weapon = YOLO("models/weapon_model_final.pt")
...
async def websocket_endpoint(websocket: WebSocket):
    ...
    await websocket.send_json({
        "type": "system",
        "message": "🛡️ NEXUS SENTINEL Connected",
        "status": "online",
        "version": "2.0"
    })
    ...
    try:
        while True:
            ...
            if "text" in data:
                ...
                # ==========================================
                # WEAPON DETECTION - ULTIMATE SENSITIVE
                # ==========================================
                ...
                for box in results_weapon[0].boxes:
                    ...
                    # ✅ KNIFE: 20% confidence par bhi detect
                    if weapon_name == "knife":
                        KNIFE_THRESHOLD = 0.20  # ✅ Very low threshold
